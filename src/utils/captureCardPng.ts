...
export function resetCardElementCaptureStyles(cardElement: HTMLElement) {
...
export function formatPngCaptureReport(result: PngCaptureResult) {
  return [
...
export async function captureCardPng(cardElement: HTMLElement): Promise<PngCaptureResult> {
  ...
  try {
    ...
    const captureResult: PngCaptureResult = {
      blob,
      metrics,
      layoutComparison,
    ...
    console.info('[PNG export diagnostics]\n' + formatPngCaptureReport(captureResult))
